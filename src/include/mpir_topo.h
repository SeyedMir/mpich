...
int a2aV_make_all_combined_msgs(int t, void *exchange_recvbuf, int *friend_off_counts,
...
int a2aV_exchange_data_with_friend(int t, const void *sendbuf, const int *sendcounts,
